...
export const COURSES = [
  {
    ...
    lessonsCount: 64,
    resultsNote: "O'quvchilarimizning 85%dan ortig'i 7.0+ IELTS balga erishadi.",
    price: "890 000",
  ...
  },
  {
    ...
    lessonsCount: 96,
    resultsNote: "Kurs oxirida o'quvchilarning 90%i erkin muloqot darajasiga chiqadi.",
    price: "590 000",
  ...
  },
  {
    ...
    lessonsCount: 72,
    resultsNote: "O'quvchilarning aksariyati DTM va OTM imtihonlarida yuqori ball to'playdi.",
    price: "520 000",
    level: "8-11 sinf",
    students: 356,
  ...
  },
  {
    ...
    weekly: "Haftasiga 3 kun, 80 daqiqa",
    lessonsCount: 72,
    resultsNote: "6 oy ichida kundalik muloqotda erkin so'zlasha olish darajasiga chiqiladi.",
    price: "480 000",
  ...
  },
  {
    ...
    lessonsCount: 60,
    resultsNote: "O'quvchilar kurs oxirida portfolio uchun real loyiha yaratadi.",
    price: "750 000",
    level: "Boshlang'ich",
    students: 187,
  ...
  },
  {
    ...
    lessonsCount: 32,
    resultsNote: "O'quvchilar DTM formatidagi testlarda barqaror yuqori ball oladi.",
    price: "420 000",
    level: "9-11 sinf",
    students: 210,
